...
-- Note: guess-indent.nvim now automatically detects indent settings from the file content
...
require('lazy').setup({
  ...
  -- 🌟 Git Interface with neogit
  {
    ...
    keys = {
      ...
      { '<leader>gN', '<cmd>Neogit kind=split<cr>', desc = 'Open Neogit (split)' },
    ...
    config = function()
      require('neogit').setup({
        ...
        -- Disables inserting the default commit message
        ...
        -- The time delay before refreshing the status buffer (in ms)
        status = {
